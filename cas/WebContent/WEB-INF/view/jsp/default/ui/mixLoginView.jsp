...
<table border="0" cellspacing="0" cellpadding="0" class="login_box">  
 ...
 <tr>
  ...
  <td><a id="forgetPwd" href="https://bca.baogang.info/buap/buap/getPassword.html" target="_blank">忘记密码?</a></td>
  ...
  <tr>
    <td colspan="2">
    <div class="bottonfld">
    <input  type="submit" class="loginbtn1"  /> 
    <input   class="loginbtn2"  type="reset" id="reset"/>
    </div>
    </td>
  </tr>
</table>
