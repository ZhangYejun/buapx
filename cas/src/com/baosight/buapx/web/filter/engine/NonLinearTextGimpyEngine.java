package com.baosight.buapx.web.filter.engine;
...
public class NonLinearTextGimpyEngine extends ListImageCaptchaEngine {
	protected void buildInitialFactories() {
	    ...
	    TextPaster randomPaster = new GlyphsPaster(Integer.valueOf(7), Integer.valueOf(7), new RandomListColorGenerator(new Color[] { new Color(23, 170, 27), new Color(220, 34, 11), new Color(23, 67, 172) }), new GlyphsVisitors[] { new TranslateGlyphsVerticalRandomVisitor(1.0D), new OverlapGlyphsUsingShapeVisitor(3.0D), new TranslateAllToRandomPointVisitor() });

	    BackgroundGenerator back = new UniColorBackgroundGenerator(Integer.valueOf(200), Integer.valueOf(70), Color.white);

	    FontGenerator shearedFont = new RandomFontGenerator(Integer.valueOf(50), Integer.valueOf(50), new Font[] { new Font("nyala", 1, 50), new Font("Bell MT", 0, 50), new Font("Credit valley", 1, 50) }, false);
	    ...
	    WordToImage word2image = new DeformedComposedWordToImage(false, shearedFont, back, randomPaster, new ArrayList(), new ArrayList(), textDef);
