...
<body onload="document.getElementById('input_pw').focus()">
	...
	<div class="logo"><img src="images/login_logo.png" width="160" height="42" alt=""><img src="images/login_logo2.png" width="148" height="38" alt=""></div>

	<div id="login">
	<div class="link" >
<div id="slidebox">
	<ul id="slides">
<!--		<li > <img src="images/login_img.jpg" /></li>-->
		...
		<li ><img src="images/Slides-3.png" /></li>
			...
			<form:form method="post" commandName="${commandName}"
				...
				<div id="go2register">
					<a href="http://buapx.rizhaosteel.com/buapx/BUAPX/UA/SY/userLabel.jsp">忘记密码？</a>
					(初始密码为身份证后8位或者工号)
		...
		<div class="foot">
		<br>统一认证平台 版权所有Copyright © 2013-2016</div>
