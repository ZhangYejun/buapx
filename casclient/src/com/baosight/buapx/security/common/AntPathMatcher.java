 ...
 * @author Mai ,引用自Spring framework,用于匹配ant风格的字符串 ,?单字符，*任意文件名，**任意目录
 * @since 16.07.2003
 */
public class AntPathMatcher implements PathMatcher {
	...
	public static void main(String[] args) {
		...
		System.out.println(p.isPattern("/**/test.jsp")+""+p.match("/**/test.jsp", "/xx/test.jsp"));
		System.out.println(p.match("/**/*test.jsp", "/xx/ss/test.jsp"));
		System.out.println(p.match("/*test.jsp", "/test.jsp"));
		System.out.println(p.isPattern("/test.jsp")+""+p.match("/test.jsp", "/test.jsp"));
		System.out.println(p.isPattern("/test.jsp")+""+p.match("/test.jsp", "/text.jsp"));
	}
